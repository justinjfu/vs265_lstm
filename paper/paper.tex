...
gradient descent with momentum. All weights are randomly initialized
...
across time and select the class with the maximum average response.

\[ class = argmax_{i}(\sum_{t} o_{i}^{t}) \]
...
in Vinyals et al. [2], and change our loss function to reflect
